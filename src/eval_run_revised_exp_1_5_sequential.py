...
# set model run args
run_name="cot_2_4_shot_set_2_sequential_"
temperature = 0.1
max_new_tokens = 1500
...
ic_dataset_path = path_prefix + f"/../data/cot_ic_set_2_exp_Sequential Reasoning Prompt.csv"
print("loading In-context examples from: ", ic_dataset_path)
...
ic_ids = ["f745ba65-3599-4d35-9857-7e14768455f9",
          ...
          "7171551c-b444-47dc-9ee4-de6fd0a4d928"]
